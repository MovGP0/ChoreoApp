...
public static class DynamicSchemeFactory
{
    ...
    public static DynamicScheme Create(
        ...
        Color? error)
    {
        var sourceColorHct = Hct.FromInt(Color.ArgbFromColor(sourceColor));
        ...
        TonalPalette primaryPalette = primary == null
            ...
            : ColorSpecs.Get(specVersion).GetPrimaryPalette(variant, Hct.FromInt(Color.ArgbFromColor(primary)), isDark, platform, contrastLevel);
        ...
        TonalPalette secondaryPalette = secondary == null
            ...
            : ColorSpecs.Get(specVersion).GetSecondaryPalette(variant, Hct.FromInt(Color.ArgbFromColor(secondary)), isDark, platform, contrastLevel);
        ...
        TonalPalette tertiaryPalette = tertiary == null
            ...
            : ColorSpecs.Get(specVersion).GetTertiaryPalette(variant, Hct.FromInt(Color.ArgbFromColor(tertiary)), isDark, platform, contrastLevel);
        ...
        TonalPalette neutralPalette = neutral == null
            ...
            : ColorSpecs.Get(specVersion).GetNeutralPalette(variant, Hct.FromInt(Color.ArgbFromColor(neutral)), isDark, platform, contrastLevel);
        ...
        TonalPalette neutralVariantPalette = neutralVariant == null
            ...
            : ColorSpecs.Get(specVersion).GetNeutralVariantPalette(variant, Hct.FromInt(Color.ArgbFromColor(neutralVariant)), isDark, platform, contrastLevel);
        ...
        TonalPalette? errorPalette = error == null
            ...
            : ColorSpecs.Get(specVersion).GetErrorPalette(variant, Hct.FromInt(Color.ArgbFromColor(error)), isDark, platform, contrastLevel);
