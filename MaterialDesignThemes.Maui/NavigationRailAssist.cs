...
public static class NavigationRailAssist
{
    ...
    public static readonly BindableProperty FloatingContentProperty =
        BindableProperty.CreateAttached(
            "FloatingContent",
            typeof(object),
            typeof(NavigationRailAssist),
    ...
    public static object? GetFloatingContent(BindableObject element) =>
        element.GetValue(FloatingContentProperty);

    public static void SetFloatingContent(BindableObject element, object? value) =>
        element.SetValue(FloatingContentProperty, value);
