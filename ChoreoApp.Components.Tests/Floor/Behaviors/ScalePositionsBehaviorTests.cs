...
public sealed class ScalePositionsBehaviorTests(ITestOutputHelper testOutputHelper) : FeatureFixture
{
    ...
    {
        _context = FloorBehaviorTestContext<ScalePositionsBehavior>.Create(services =>
        {
