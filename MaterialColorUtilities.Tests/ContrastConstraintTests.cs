    ...
    private sealed class ContrastConstraint : IConstraint
    {
        ...
        public void TestAgainst(DynamicScheme scheme)
        {
            ...
            if (desired <= 4.5)
            {
                ...
                {
                    throw new Xunit.Sdk.XunitException(FormatMessage(scheme, desired, actual));
                }
            }
            else
            {
                ...
                {
                    throw new Xunit.Sdk.XunitException(FormatMessage(scheme, 4.5, actual));
                }
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    [Fact(DisplayName = "scheme_correctness_test: all variants & contrast levels satisfy constraints")]
