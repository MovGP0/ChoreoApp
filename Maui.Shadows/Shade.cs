...
public class Shade : Element
{
    ...
    private static readonly Color DefaultColor = Color.FromRgba(0, 0, 0, DefaultOpacity);
    private static readonly Point DefaultOffset = new Point(0, 8);

    private readonly WeakEventSource<PropertyChangedEventArgs> _weakPropertyChangedSource = new();
    ...
    public override string ToString() =>
        $"{{ Offset: {Offset}, Color: {{A={Color.Alpha}, R={Color.Red}, G={Color.Green}, B={Color.Blue}}}, Opacity: {Opacity}, BlurRadius: {BlurRadius} }}";
